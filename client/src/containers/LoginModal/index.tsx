...
const { LOGIN, SUBMIT, EMAIL, PASSWORD, NO_MATCH, MATCH, NO_ACCOUNT_YET } = CONSTANTS.TEXT.LOGIN_MODAL;
            ...
            <div className={`flex justify-center items-center h-full`}>
                ...
                >
                    <div className={`flex justify-center items-center flex-col`}>
                        <div className={`pt-6 pb-3 text-2xl w-full text-center`}>
                            {LOGIN}
                            {noMatchShow && <div className={`text-red-500 text-sm pt-1`}>{NO_MATCH}</div>}
                            {matchShow && <div className={`text-green-500 text-sm pt-1`}>{MATCH}</div>}
                        </div>
                        ...
                        <Button
                            ...
                            text={SUBMIT}
                            className={`w-36 h-8 mt-4 text-cyan-300 hover:bg-primary hover:text-white hover:rounded hover:shadow-lg hover:shadow-cyan-300/50`}
                        />
                    </div>
                </div>
            </div>
